define(["require", "exports", "./uniqueId"], function (require, exports, uniqueId_1) {
    "use strict";
    ...
    exports.compressDataUrl = function (b64) {
    ...
    var FileCompress = /** @class */ (function () {
        ...
        FileCompress.prototype.compressImgFromFile = function (file) {
            ...
            filename = uniqueId_1.getUniqueId() + ".jpg";
            return new Promise(function (resolve, reject) {
                var fr = new FileReader();
                fr.onload = function () {
                    var resultB64 = fr.result;
                    if (resultB64 && typeof (resultB64) === "string") {
                        exports.compressDataUrl(resultB64)
